...
public class TranslateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        YouDaoApplication.init(this, "4bd765b150aae12c");
        ...
        exitDialog.setItemListener(new SwListDialog.ItemListener() {
            ...
            public void click(int position, String title) {
                ...
                if (!from.contains(lan) && !to.contains(lan)
                    ...
                    Toast.makeText(TranslateActivity.this, "源语言或者目标语言其中之一必须为"+lan, Toast.LENGTH_SHORT).show();
    ...
    private void query() {
        ...
        TranslateParameters tps = new TranslateParameters.Builder()
                .source("youdaotest").from(langFrom).to(langTo).sound(Constants.SOUND_OUTPUT_MP3).voice(Constants.VOICE_BOY_UK).timeout(3000).build();// appkey可以省
            ...
            public void onError(final TranslateErrorCode error, String requestId) {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(TranslateActivity.this, "查询错误"+error.name(), Toast.LENGTH_SHORT).show();
                        dismissLoadingView();
                    }
                });
            }
