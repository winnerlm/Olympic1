...
import worker.adapter.DeviceAdapter;
import worker.broadcast.DirectBroadcastReceiver;
import worker.callback.DirectActionListener;
import worker.common.LoadingDialog;
import worker.model.FileTransfer;
import worker.task.WifiClientTask;

import static worker.wifibase.StartSendActivity.getDeviceStatus;
