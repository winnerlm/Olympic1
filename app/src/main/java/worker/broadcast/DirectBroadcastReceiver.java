...
import worker.callback.DirectActionListener;
import worker.wifibase.ReceiveFileActivity;
import worker.wifibase.SendFileActivity;
...
public class DirectBroadcastReceiver extends BroadcastReceiver {
    ...
    public DirectBroadcastReceiver(WifiP2pManager wifiP2pManager, WifiP2pManager.Channel channel, SendFileActivity directActionListener) {
        mWifiP2pManager = wifiP2pManager;
        mChannel = channel;
        mDirectActionListener = directActionListener;
    }

    public DirectBroadcastReceiver(WifiP2pManager wifiP2pManager, WifiP2pManager.Channel channel, ReceiveFileActivity receiveFileActivity) {
    }
