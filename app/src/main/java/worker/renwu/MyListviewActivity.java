...
import worker.contact.ContactMainActivity;
import worker.wifibase.StartSendActivity;
...
public class MyListviewActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, final View view, final int position, long l) {
                ...
                new AlertDialog.Builder(MyListviewActivity.this)
                        ...
                        .setMessage("再次确定任务")
                        .setView(mView)
                        .setPositiveButton("联系人员", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent=new Intent(MyListviewActivity.this, ContactMainActivity.class);
    ...
    private void initView() {
        ...
        btn_chuanshu=(Button)findViewById(R.id.btn_chuanshu);
    ...
    private void initEvent() {
        ...
        btn_tixing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(MyListviewActivity.this,TimeCountActivity.class);
                startActivity(intent);
            }
        });

        btn_chuanshu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MyListviewActivity.this, StartSendActivity.class);
                startActivity(intent);
            }
        });
