...
import com.example.wenhaibo.vister.overlay.PoiOverlay;

import java.util.List;

public class FoodActivity extends AppCompatActivity implements LocationSource,AMapLocationListener , View.OnClickListener,PoiSearch.OnPoiSearchListener, AMap.OnMarkerClickListener, AMap.InfoWindowAdapter {
    ...
    private void setUp() {
        ...
        String[] ints = {"1000","2000","3000","4000","5000","6000","7000","8000","9000","10000"};
   ...
   long firstTime = 0;
    ...
    private void search(){
        ...
        Log.i("---", keyWord);
        if ("".equals(keyWord)){
            Toast.makeText(FoodActivity.this, "请输入搜索关键字",Toast.LENGTH_SHORT).show();
            return;
        }else {
            doSearchQuery();
        }
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        Toast.makeText(FoodActivity.this, infomation,Toast.LENGTH_SHORT).show();
            ...
            if (poiResult != null && poiResult.getQuery() != null) {// 搜索poi的结果
                if (poiResult.getQuery().equals(query)) {// 是否是同一条
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(FoodActivity.this, "未找到结果",Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(FoodActivity.this, "该距离内没有找到结果",Toast.LENGTH_SHORT).show();
            }
        } else {
            Log.i("---","查询结果:"+i);
            Toast.makeText(FoodActivity.this, "异常代码---"+i,Toast.LENGTH_SHORT).show();
        }
    ...
    public View getInfoWindow(final Marker marker) {
        ...
        Button button = (Button) view.findViewById(R.id.start_amap_app);
        // 调起高德地图app
